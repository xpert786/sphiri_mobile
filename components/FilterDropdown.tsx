        ...
        if (visible) {
            ...
            if (handle) {
                UIManager.measure(handle, (x, y, width, height, pageX, pageY) => {
                    ...
                    const dropdownW = screenWidth * 0.5;
                    
                    let left = pageX;
                    if (left + dropdownW > screenWidth - 10) {
                        left = screenWidth - dropdownW - 10;
                    }
                    
                    setDropdownTop(pageY + height + 2);
                    setDropdownLeft(left);
                    setContainerWidth(dropdownW);
                    setVisible(true);
                });
            }
        }
            ...
            <View ref={containerRef}>
                <TouchableOpacity onPress={toggleDropdown} activeOpacity={0.8}>
                    <CustomTextInput
                        ...
                        parentStyles={{ pointerEvents: 'none', marginBottom: 0 }}
