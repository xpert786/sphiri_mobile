...
interface TaskTrusteeModalProps {
    visible: boolean;
    onClose: () => void;
    document: Document | null;
}

const TaskTrusteeModal: React.FC<TaskTrusteeModalProps> = ({ visible, document, onClose }) => {
            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.section}>
                        <View style={styles.primaryUserCard}>
                            <Text style={styles.primaryUserText}>
                                Task Status: {document.status}. You can mark this task as complete or reschedule it. Updates are shared with the primary user and other family members with access to this task.
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.contactField}>
                            <Text style={styles.contactLabel}>Due Date</Text>
                            <Text style={styles.contactValue}>{document.dueDate}</Text>
                        </View>

                        <View style={styles.contactField}>
                            <Text style={styles.contactLabel}>Status</Text>
                            <Text style={styles.contactValue}>{document.status}</Text>
                        </View>

                        <View style={styles.contactField}>
                            <Text style={styles.contactLabel}>Contact</Text>
                            <Text style={styles.contactValue}>{document.contactName}</Text>
                        </View>
                    </View>
...
export default TaskTrusteeModal;