...
//         setLoading(true);
//         try {
//             console.log("Adding client with payload:", newClient);
//             const response = await apiPost(ApiConstants.VENDOR_CLIENTS, newClient);
//             console.log("Add client response:", response.status, response.data);
...
//                 onClose();
//             } else {
//                 setAlertTitle(response.data?.message || 'Failed to add client. Please try again.');
//                 setShowValidationModal(true);
//             }
//         } catch (error: any) {
//             console.error('Add Client Error Full:', error.response?.data || error.message);
...
//                     // Handle field-specific errors common in Django/REST frameworks
...
//                                         multiline={true}
//                                         multiStyles={{ height: 200, textAlignVertical: 'top' }}
//                                     />
//                                 </ScrollView>
...
//         borderRadius: 24, // Rounded corners for centered modal
//         padding: 24,
//         maxHeight: '80%',
//         width: '100%',
