...
const LegalDocumentsModal: React.FC<LegalDocumentsModalProps> = ({ visible, document, onClose }) => {
                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.section}>
                        <View style={styles.primaryUserCard}>
                            <Text style={styles.primaryUserText}>
                                {document.name}- Access Level: {document.linkedTo}. Notes: {document.notes}. Status: {document.verified ? 'Verified' : 'Not Verified'}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.contactField}>
                            ...
                            <Text style={styles.contactValue}>{document.name}</Text>
                        </View>

                        <View style={styles.contactField}>
                            <Text style={styles.contactLabel}>Access Level</Text>
                            <Text style={styles.contactValue}>{document.linkedTo}</Text>
                        </View>
                    </View>
