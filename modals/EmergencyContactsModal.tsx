...
interface EmergencyContactsModalProps {
    visible: boolean;
    onClose: () => void;
    contact: DocumentItem | null;
}

const EmergencyContactsModal: React.FC<EmergencyContactsModalProps> = ({ visible, contact, onClose }) => {
                    ...
                    <View style={styles.section}>
                        <View style={styles.primaryUserCard}>
                            <Text style={styles.primaryUserText}>
                                {contact.linkedTo}. Phone: {contact.phone}. Email: {contact.email}. Notes: {contact.notes}
                            </Text>
                        </View>
                    </View>
